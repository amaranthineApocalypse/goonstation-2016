...
/obj/item/robot_module/standard
	...
	New()
		...
		src.modules += new /obj/item/reagent_containers/glass/bucket/borg(src)
...
/datum/robot_cosmetic/civilian //A combo of the hydro and janitor modules! - AmaranthineApocalypse
...
/obj/item/robot_module/brobot //TO DO: add magic pen/crayon
	...
	New()
		...
		src.modules += new /obj/item/device/flashlight/brobot(src) //this doubles as the borg siren light
